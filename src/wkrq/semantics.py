...
class WeakKleeneSemantics:
    ...
    def _build_conjunction_table(self) -> Dict[tuple, TruthValue]:
        ...
        return {
            (TRUE, TRUE): TRUE,
            (TRUE, UNDEFINED): UNDEFINED,    # Weak Kleene: any undefined input → undefined output
            (TRUE, FALSE): FALSE,
            (UNDEFINED, TRUE): UNDEFINED,    # Weak Kleene: any undefined input → undefined output
            (UNDEFINED, UNDEFINED): UNDEFINED,
            (UNDEFINED, FALSE): UNDEFINED,   # Weak Kleene: any undefined input → undefined output
            (FALSE, TRUE): FALSE,
            (FALSE, UNDEFINED): UNDEFINED,   # Weak Kleene: any undefined input → undefined output
            (FALSE, FALSE): FALSE
        }
