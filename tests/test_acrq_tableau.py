...
from wkrq.signs import F, M, N, T, SignedFormula
...
class TestACrQTableau:
    ...
    def test_paraconsistent_inference(self):
        ...
        f2 = parse_acrq_formula("¬Human(alice)", SyntaxMode.TRANSPARENT)  # Becomes Human*(alice)
