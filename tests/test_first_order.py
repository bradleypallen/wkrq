...
from wkrq.parser import parse, ParseError
...
class TestFirstOrderSemantics:
    ...
    def test_predicate_reasoning(self):
        ...
        assert result.satisfiable  # Should have models where P(a) is false or Q(a) is true
...
class TestRestrictedQuantifiers:
    ...
    def test_restricted_existential_reasoning(self):
        ...
        human_a = Formula.predicate("Human", [a])
        ...
        assert result.satisfiable, "Complex formula with restricted existential should be satisfiable"
    ...
    def test_restricted_universal_reasoning(self):
        ...
        complex_formula = premise1 & student_a
        result = solve(complex_formula, T)
        assert result.satisfiable, "Complex formula with restricted universal should be satisfiable"