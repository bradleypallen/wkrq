...
class TestACrQEvaluator:
    ...
    def test_knowledge_gap_evaluation(self):
        ...
        human = BilateralPredicateFormula("Human", [Constant("charlie")], is_negative=False)
        assert evaluator.evaluate(human) == FALSE
        
        human_star = BilateralPredicateFormula("Human", [Constant("charlie")], is_negative=True)
        assert evaluator.evaluate(human_star) == FALSE
    ...
    def test_bilateral_contradiction_handling(self):
        ...
        alice_human = BilateralPredicateFormula("Human", [Constant("alice")], is_negative=False)
        alice_human_star = BilateralPredicateFormula("Human", [Constant("alice")], is_negative=True)
    ...
    def test_evaluate_acrq_function(self):
        ...
        robot = BilateralPredicateFormula("Robot", [Constant("r2d2")], is_negative=False)
        robot_star = BilateralPredicateFormula("Robot", [Constant("r2d2")], is_negative=True)
